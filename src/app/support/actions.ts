...
export async function sendSupportTicket(prevState: SupportTicketFormState, formData: FormData) {
  ...
  `
    ...
    try {
        ...
        return { success: false, message: "There was a server problem. Please try later: + " + error }
    }
}