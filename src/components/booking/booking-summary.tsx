                ...
                <div className="flex flex-col gap-4">
                    <div className="flex flex-col gap-2 px-1">
                        ...
                        <div className="flex flex-row gap-2 items-center">
                            ...
                            <p className="font-normal text-[#555] text-sm">{`${getHours(appointmentTime)}:${getMinutes(appointmentTime) == 0 ? `${getMinutes(appointmentTime)}0` : getMinutes(appointmentTime)}`} {calculateDuration()}</p>
                        </div>
                    </div>
