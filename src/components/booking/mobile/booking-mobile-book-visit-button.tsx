...
import { BookinLoginModal } from "../../modals/booking-login-modal";
...
export default function BookingMobileBookVisitButton({services, businessId}:BookingMobileBookVisitButtonProps) {
    ...
    return (
        <button 
            ...
            className="w-full text-center font-normal text-base rounded-xl md:w-full py-3 bg-linear-to-b from-[#313131] to-[#141414] text-[#FFFFFF] hover:bg-[#333]"
        >
            Zarezerwuj
        </button>
    )
