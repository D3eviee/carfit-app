...
export default function CalendarMobileMonth() {
  const setOpenCalendar = useBusinessCalendarNavigationStore(store => store.setCalendarType)
  ...
  return (
    <div className="w-full shadow-[0px_0px_0px_1px_5px_#CCCCCC30] rounded-md  border">
      {/* CALENDAR NAVIGATION */}
