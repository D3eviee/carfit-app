...
export const DashboardCalendarSecondaryMonthCalendar = () => {
  ...
  return (
    <div className="w-full rounded-2xl border-[0.5px] border-[#D4D4D4] shadow-sm">
      {/* CALENDAR NAVIGATION */}
      <div className="w-full flex items-center items justify-between px-3 py-4">
        ...
        <div className="flex flex-row gap-2">
          <button 
            className="p-1 bg-[#191919] rounded-lg border-[#D4D4D4] hover:bg-[#2B2B2B] hover:cursor-pointer active:scale-95" 
            ...
            {daysOfActiveMonth.map((day, i) => (
              <div key={i} className="flex flex-col justify-center items-center py-2">
                <div 
                  ...
                  isSameDay(activeDay, day) ? "bg-[#191919] text-white font-semibold" : "", 
                  )}
