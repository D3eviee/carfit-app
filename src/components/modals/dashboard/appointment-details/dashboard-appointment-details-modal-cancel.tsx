...
import { DashboardAppointmentCancelModal } from "../appointment-cancel/dashboard-appointment-cancel-modal"

export const DashboardAppointmentDetailsModalCancel= ({appointmentId}:{appointmentId:string}) => {
