...
interface UserProfileModalSubmitButtonProps extends ButtonHTMLAttributes<HTMLButtonElement> { 
  isPending: boolean
}

export const UserProfileModalSubmitButton = ({isPending, ...props}:UserProfileModalSubmitButtonProps) => {
  return (
    <button
      type="submit" 
