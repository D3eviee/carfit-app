    ...
    <div className='relative'>
      ...
      >
        {images.map((image) => (
          <div
            ...
            key={image.id}
            className="shrink-0 w-screen snap-center relative hover:cursor-pointer"
          >
            <Image
              src={image.photoUrl}
              alt="business image"
      ...
      >
        ...
        <div className='flex flex-row gap-5'>
          ...
          >
            <ChevronLeft strokeWidth={1.5} className='mr-0.5'/>
          </button>
          <button
          ...
          >
            <ChevronRight strokeWidth={1.5} className='ml-0.5'/>
          </button>
        </div>
      </div>
    </div>
