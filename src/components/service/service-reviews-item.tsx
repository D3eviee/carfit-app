...
export const ServiceReviewItem = ({review}: {review:Review}) => {
  ...
  return (
    <div className="w-full px-4 py-5 flex flex-col shadow-inner-glass border-1 border-[#F2F2F2] bg-[#FAFAFA] gap-4 rounded-2xl">
      <div className="flex flex-col gap-1">
        <h2 className="text-main-black text-[15px] font-medium leading-none tracking-normal">{title}</h2>
