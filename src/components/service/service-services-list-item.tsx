...
export const ServiceServicesListItem = ({service}:{service:Service}) => {
  ...
  return (
    <div 
      ...
      className="w-full flex flex-row items-center justify-between px-4 py-5 border-2 border-[#F2F2F8] bg-white rounded-2xl transition-all duration-75 hover:cursor-pointer hover:border-black/20"
    >
